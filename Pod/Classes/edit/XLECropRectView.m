...
#import "XLECropRectView.h"
#import "XLEResizeControl.h"

@interface XLECropRectView ()<XLEResizeControlViewDelegate>

@property (nonatomic) XLEResizeControl *topLeftCornerView;
@property (nonatomic) XLEResizeControl *topRightCornerView;
@property (nonatomic) XLEResizeControl *bottomLeftCornerView;
@property (nonatomic) XLEResizeControl *bottomRightCornerView;
@property (nonatomic) XLEResizeControl *topEdgeView;
@property (nonatomic) XLEResizeControl *leftEdgeView;
@property (nonatomic) XLEResizeControl *bottomEdgeView;
@property (nonatomic) XLEResizeControl *rightEdgeView;
...
@implementation XLECropRectView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        imageView.image = [[UIImage xlei_imageNamed:@"xle_image_crop"] resizableImageWithCapInsets:UIEdgeInsetsMake(23.0f, 23.0f, 23.0f, 23.0f)];
        [self addSubview:imageView];
        
        self.topLeftCornerView = [[XLEResizeControl alloc] init];
        self.topLeftCornerView.delegate = self;
        [self addSubview:self.topLeftCornerView];
        
        self.topRightCornerView = [[XLEResizeControl alloc] init];
        self.topRightCornerView.delegate = self;
        [self addSubview:self.topRightCornerView];
        
        self.bottomLeftCornerView = [[XLEResizeControl alloc] init];
        self.bottomLeftCornerView.delegate = self;
        [self addSubview:self.bottomLeftCornerView];
        
        self.bottomRightCornerView = [[XLEResizeControl alloc] init];
        self.bottomRightCornerView.delegate = self;
        [self addSubview:self.bottomRightCornerView];
        
        self.topEdgeView = [[XLEResizeControl alloc] init];
        self.topEdgeView.delegate = self;
        [self addSubview:self.topEdgeView];
        
        self.leftEdgeView = [[XLEResizeControl alloc] init];
        self.leftEdgeView.delegate = self;
        [self addSubview:self.leftEdgeView];
        
        self.bottomEdgeView = [[XLEResizeControl alloc] init];
        self.bottomEdgeView.delegate = self;
        [self addSubview:self.bottomEdgeView];
        
        self.rightEdgeView = [[XLEResizeControl alloc] init];
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (UIView *subview in subviews) {
        if ([subview isKindOfClass:[XLEResizeControl class]]) {
...
- (CGRect)cropRectMakeWithResizeControlView:(XLEResizeControl *)resizeControlView
{
