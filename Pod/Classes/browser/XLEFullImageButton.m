...
- (UIImageView *)fullImageView
{
    if (_fullImageView == nil) {
        _fullImageView = [[UIImageView alloc] initWithImage:[UIImage xlei_imageNamed:@"xle_full_image_unselected"] highlightedImage:[UIImage xlei_imageNamed:@"xle_full_image_selected"]];
