...
- (void)updateFlashButtons
{
    ...
    //TODO 图片
    [self.flashButton setImage:[UIImage xlei_imageNamed:imageName] forState:UIControlStateNormal];
}
...
- (UIButton *)flashButton{
    if (_flashButton == nil) {
        _flashButton = ({
            UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
            [button setImage:[UIImage xlei_imageNamed:@"xle_camera_flash"] forState:UIControlStateNormal];
            button;
        });
...
- (UIButton *)frontButton{
    if (_frontButton == nil) {
        _frontButton = ({
            UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
            [button setImage:[UIImage xlei_imageNamed:@"xle_camera_front"] forState:UIControlStateNormal];
            button;
        });
