...
- (UIButton *)takeButton{
    if (_takeButton == nil) {
        _takeButton = ({
            ...
            [button setImage:[UIImage xlei_imageNamed:@"xle_camera_take"] forState:UIControlStateNormal];
            [button setImage:[UIImage xlei_imageNamed:@"xle_camera_take_press"] forState:UIControlStateHighlighted];
            button;
        });
